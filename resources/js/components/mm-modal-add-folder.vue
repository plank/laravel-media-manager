                    ...
                    <g id="icon-upload" transform="translate(-11.000000, 0.000000)">
                        ...
                        <g id="Group" transform="translate(0.000000, 47.000000)">
                            ...
                            <g transform="translate(90.400000, 0.000000)" stroke="#000000" stroke-width="2">
                                ...
                                <path d="M128.032,49.519 L79.832,1.319 C78.545137,0.0321211977 76.6098355,-0.352950912 74.9283811,0.343313891 C73.2469268,1.03957869 72.15,2.68008979 72.15,4.5 L72.15,40.65 C72.15,49.775 79.574,57.2 88.7,57.2 L124.85,57.2 C126.669653,57.2 128.309985,56.1033794 129.006416,54.4222722 C129.702846,52.741165 129.318293,50.8060853 128.032,49.519 L128.032,49.519 Z" id="Path" fill="#ECEBEB" fill-rule="nonzero"></path>
                            </g>
                            <circle id="Oval" stroke="#000000" stroke-width="2" fill="#FFFFFF" fill-rule="nonzero" cx="154.75" cy="150.75" r="18.75"></circle>
                            <path d="M156.107,149.86 C155.959377,149.860001 155.839551,149.740622 155.839,149.593 L155.839,143.7 L153.161,143.7 L153.161,149.593 C153.161,149.741 153.041,149.861 152.893,149.861 L147,149.861 L147,152.539 L152.893,152.539 C153.041,152.539 153.161,152.659 153.161,152.807 L153.161,158.7 L155.839,158.7 L155.839,152.807 C155.839,152.659 155.959,152.539 156.107,152.539 L162,152.539 L162,149.861 L156.107,149.861 L156.107,149.86 Z" id="Path" stroke="#000000" stroke-width="1.1" fill="#000000" fill-rule="nonzero" stroke-linejoin="round"></path>
                        </g>
                        <circle id="Oval" fill="#DADADA" fill-rule="nonzero" cx="76.975" cy="46.478" r="3.5"></circle>
                        <circle id="Oval" fill="#DADADA" fill-rule="nonzero" cx="110.975" cy="22.478" r="7.5"></circle>
                        <circle id="Oval" fill="#DADADA" fill-rule="nonzero" cx="228.975" cy="217.478" r="7.5"></circle>
                    </g>
                </g>
            </svg>
        </div>
