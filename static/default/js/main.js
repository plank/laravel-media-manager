...
var _default = {
  ...
  data: function data() {
    return {
      message: 'Media Manager [ bedta ]'
    };
  }
};
exports.default = _default;
        var $a347b2 = exports.default || module.exports;
      
      if (typeof $a347b2 === 'function') {
        $a347b2 = $a347b2.options;
      }
    
        /* template */
        Object.assign($a347b2, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a347b2', $a347b2);
          } else {
            api.reload('$a347b2', $a347b2);
          }
        }
